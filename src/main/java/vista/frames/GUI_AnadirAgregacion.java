...
public class GUI_AnadirAgregacion extends Parent_GUI{
	...
	private void initComponents() {
		...
		setIconImage(new ImageIcon(getClass().getClassLoader().getResource(ImagesPath.LOGODBDT)).getImage());
		...
		pane.setIconImage(new ImageIcon(getClass().getClassLoader().getResource(ImagesPath.LOGODBDT)).getImage());
