...
public class GUI_Manual extends JFrame{
	...
	public GUI_Manual() {
		...
		this.setIconImage(new ImageIcon(getClass().getClassLoader().getResource(ImagesPath.LOGODBDT)).getImage());
		...
		ImageIcon im1 = new ImageIcon(getClass().getClassLoader().getResource(ImagesPath.IMAGE1));
		JLabel label1 = new JLabel (im1);
		label1.setBorder(BorderFactory.createEmptyBorder());
		
		ImageIcon im2 = new ImageIcon(getClass().getClassLoader().getResource(ImagesPath.IMAGE2));
		JLabel label2 = new JLabel (im2);
		label2.setBorder(BorderFactory.createEmptyBorder());
		
		ImageIcon im3 = new ImageIcon(getClass().getClassLoader().getResource(ImagesPath.IMAGE3));
