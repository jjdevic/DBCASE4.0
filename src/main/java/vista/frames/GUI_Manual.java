...
public class GUI_Manual extends JFrame {
    ...
    public GUI_Manual() {
        ...
        ImageIcon im1 = new ImageIcon(getClass().getClassLoader().getResource(ImagesPath.CONCEPT_SCH));
        JLabel label1 = new JLabel(im1);
        label1.setBorder(BorderFactory.createEmptyBorder());

        ImageIcon im2 = new ImageIcon(getClass().getClassLoader().getResource(ImagesPath.LOGIC_SCHEMA));
        JLabel label2 = new JLabel(im2);
        label2.setBorder(BorderFactory.createEmptyBorder());

        ImageIcon im3 = new ImageIcon(getClass().getClassLoader().getResource(ImagesPath.PHYSIC_SCHEMA));
