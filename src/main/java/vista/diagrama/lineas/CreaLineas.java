    ...
    protected void drawSimpleEdge(RenderContext<V, E> rc, Layout<V, E> layout, E e, String nombre1,
        ...
        //Si es linea de relacion a entidad
            ...
            if (ent.getPrincipioRango() > 0) {
                ...
                new LineaRecta(rc, layout, e, nombre1, graph, diagonal, nombre2, numApariciones, vuelta, thetaRadians, v1, v2, xIsA - incrementoX, yIsA - incrementoY, xEnti - incrementoX, yEnti - incrementoY, dx, dy, g);
            diagonal = false;
