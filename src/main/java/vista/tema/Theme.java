...
import static vista.utils.ThemesPath.*;
...
public class Theme {
	...
	*/
    ...
    private static void loadTheme() {
        ...
        try {
            ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
            InputStreamReader inputStreamReader = new InputStreamReader(Objects.requireNonNull(classLoader.getResourceAsStream(GENERAL + current + ".json")));
    ...
    public myColor ReportFontColor() {
        return colors.get("fontColor");
    }

    public myColor menuDesplegable() {
        return colors.get("menuDesplegable");
    }
